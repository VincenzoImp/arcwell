...
const equivalentArcwellSources = [
  ARCWELL_PACKAGE_SOURCE,
  "https://github.com/VincenzoImp/arcwell@v0.6.2",
  "git:https://github.com/VincenzoImp/arcwell@v0.6.2",
  "ssh://git@github.com/VincenzoImp/arcwell@v0.6.2",
  "git:ssh://git@github.com/VincenzoImp/arcwell@v0.6.2",
  "git:git@github.com:VincenzoImp/arcwell@v0.6.2",
  "git:www.github.com/VincenzoImp/arcwell@v0.6.2",
  "https://www.github.com/VincenzoImp/arcwell@v0.6.2",
  "git:git@www.github.com:VincenzoImp/arcwell@v0.6.2",
] as const;
...
test("raw SCP syntax without the git prefix remains a local source like Pi 0.84.4", () => {
  const rawScpSource = "git@github.com:VincenzoImp/arcwell@v0.6.2";
