...
Arcwell `0.3.3` requires Node.js `>=24.15.0` and targets the locally audited Pi `0.84.4` API.
...
the exact release with `npx github:VincenzoImp/arcwell#v0.3.3 setup`; Pi resources use
`pi install git:github.com/VincenzoImp/arcwell@v0.3.3`. Generate and inspect input with `setup
